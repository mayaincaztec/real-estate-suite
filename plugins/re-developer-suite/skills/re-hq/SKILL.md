...
2. Route single-domain work using `references/routing-map.md`.
3. Use subagents only when the user explicitly requests agents, parallel work, departmental coordination, DD, or deal structuring.
4. Give every subagent the handoff packet in `references/operating-contract.md`.
